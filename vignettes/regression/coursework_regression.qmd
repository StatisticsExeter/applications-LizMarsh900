...
The following box plot shows how carbon emissions vary by age of property. Specifically it shows carbon emission shortfall, which is the difference between actual carbon emissions and the predicted

![](../../data_cache/vignettes/regression/boxplot_age.html){width="100%" height="600px"}

Shortfall tends to refer to "The difference between an emissions target and the actual observed emissions"

it may be emissions shortfall i.e., target emissions - actual emissions

-   if positive the entity emitted more than the allowed target

-   if negative the the entity emitted less than the target (outperformed)

it coud be energy-efficiency shortfall

-   what energy performance should be

-   and what energy performance is
