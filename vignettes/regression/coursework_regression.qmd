...
To extend this work slightly further, I decided to created regression diagnostic plots for the model, which can be found below: ![](../../data_cache/models/diagnostics/residuals_vs_fitted.png){width="100%" height="600px"} ![](../../data_cache/models/diagnostics/qq_plot.png){width="100%" height="600px"} ![](../../data_cache/models/diagnostics/scale_location.png){width="100%" height="600px"}
