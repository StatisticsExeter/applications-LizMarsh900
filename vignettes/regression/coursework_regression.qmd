...
![](../../data_cache/models/diagnostics/qq_plot.png){width="100%" height="600px"}
![](../../data_cache/models/diagnostics/residuals_vs_fitted.png){width="100%" height="600px"}
![](../../data_cache/models/diagnostics/scale_location.png){width="100%" height="600px"}
These graphs show the residuals vs. fitted, Q-Q plot... \## Record of AI use for MTHM503 Regression coursework
